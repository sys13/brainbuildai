...
test.skip('prevents default on the first click, and does not on the second', async () => {
...
test.skip('blurring the button starts things over', async () => {
	const user = userEvent.setup()
	render(<TestComponent />)
...
test.skip('hitting "escape" on the input starts things over', async () => {
	const user = userEvent.setup()
	render(<TestComponent />)
